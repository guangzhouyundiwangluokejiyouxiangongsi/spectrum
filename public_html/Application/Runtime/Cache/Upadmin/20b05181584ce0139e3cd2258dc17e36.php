...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
				<input type="text" class="input-text" style="width:250px" placeholder="输入栏目名称" id="" name="">
				<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜栏目</button>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加栏目','<?php echo U('shuffling_add');?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="60">所属栏目</th>
							<th width="90">是否显示</th>
							<th width="70">是否新窗口打开</th>
							<th width="70">排序</th>
							<th width="60">操作</th>
						</tr>
					</thead>
					<tbody>
					<?php if(is_array($shuffling)): foreach($shuffling as $key=>$vv): ?><tr class="text-c">
							<td><input type="checkbox" value="1" name=""></td>
							<td><?php echo ($vv["id"]); ?></td>
							<td><?php echo ($vv["img_cat"]); ?></td>
							<td><a target="_blank" href="<?php echo ($vv["img"]); ?>"><?php echo ($vv["img"]); ?></a></td>
							...
							<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('<?php echo ($vv["navigation"]); ?>','shuffling_add?uid=<?php echo ($vv["id"]); ?>','<?php echo ($vv["id"]); ?>','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> </a> <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo ($vv["id"]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		$.post('shuffling_del',{'id':id},function(res){
			if (res){
