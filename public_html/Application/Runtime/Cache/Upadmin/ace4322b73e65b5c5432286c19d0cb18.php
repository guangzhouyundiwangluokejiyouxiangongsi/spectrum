...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','member-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> 
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					...
					<?php if(is_array($company_list)): foreach($company_list as $key=>$vv): ?><tr class="text-c">
							...
							<td>
							<?php if(is_array($vv[com_url])): foreach($vv[com_url] as $key=>$vo): ?><a target="_blank" href="http://<?php echo ($vo); ?>"><?php echo ($vo); ?></a>
							...
							<td class="td-manage"><a target="_blank" href="<?php echo U('user/shenhe');?>?com_id=<?php echo ($vv["com_id"]); ?>">审核&nbsp;</a><a style="text-decoration:none" target="_blank" href="/CompanyInfo/details?id=<?php echo ($vv["com_id"]); ?>" title="进入该公司百科"><i class="Hui-iconfont">&#xe631;</i></a>  <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo ($vv["com_id"]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function qiehuan(obj,id){
	...
	$.post('ajax_is_rec',{'com_is_rec':vv,'com_id':id},function(res){
		if (!res) alert('修改失败');
	})
}
