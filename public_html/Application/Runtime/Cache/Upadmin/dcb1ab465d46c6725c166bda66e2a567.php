...
<article class="cl pd-20">
	<form action="<?php echo U('Web/navigation_add');?>" method="post" class="form form-horizontal" id="form-member-add">
	<input type="hidden" name="id" value="<?php echo ($navigation2['id']); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>导航名字：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($navigation2['navigation']); ?>" placeholder="" id="username" name="navigation">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>上级导航：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="pid">
					<option value="">请选择</option>
					<option value="0" <?php if(!$navigation2['pid']): ?>selected="true"<?php endif; ?>>顶级导航</option>
					<?php if(is_array($navigation)): foreach($navigation as $kk=>$vv): ?><option value="<?php echo ($kk); ?>" <?php if($kk == $navigation2['pid']): ?>selected="true"<?php endif; ?> ><?php echo ($vv); ?></option><?php endforeach; endif; ?>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($navigation2['url']); ?>" placeholder="http://www.yundi88.com" name="url">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>排序：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($navigation2['orderid']); ?>" placeholder="50" name="orderid">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="sex-2" name="is_show" value="1"<?php if($navigation2['is_show'])echo 'checked="true"';?>>
					<label for="sex-2">显示</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-3" name="is_show" value="0" <?php if(!$navigation2['is_show'])echo 'checked="true"';?>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input type="radio" id="sex-2" name="is_new_open" value="1" <?php if($navigation2['is_new_open'])echo 'checked="true"';?> >
					<label for="sex-2">新窗口</label>
				</div>
				<div class="radio-box">
					<input type="radio" id="sex-3" name="is_new_open" value="0" <?php if(!$navigation2['is_new_open'])echo 'checked="true"';?>>
